...
class CNNNetwork():
    ...
    def __init__(self):
        self.number_of_train_data = int(10000)
        self.number_of_test_data = int(2000)
    ...
    def train_model(self, model, train_datas, train_labels, name_of_file=None, epochs=20, batch_size=40, verbose=False, with_checkpoint=False):
        if with_checkpoint:
            prefix = ''
            ...
            model.fit(train_datas, train_labels, epochs=epochs, batch_size=batch_size, callbacks=callbacks_list, verbose=0)
        else:
